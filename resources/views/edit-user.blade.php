...
<div id="main" >
  ...
  <div class="mb-3">
    ...
    <input name="name" type="text" class="form-control" aria-describedby="Help" value="{{ $user->name}}">
  ...
  <div class="mb-3">
    ...
    <input name="branch" type="text" class="form-control" aria-describedby="Help" value="{{ $user->branch}}">
